            ...
            topic.subscribe("tpl-ready", function () {
                ...
                */
                ...
                var splashPage = new Dialog({
                    title: 'Disclaimer',
                    content: "<p class='description' style='line-height: 12.0pt; background: white'><span lang=EN-GB>1." +
                        "Use of these maps is subject to these disclaimers and exclusions.By using" +
                        "these maps the user is signifying his or her agreement to be bound by these " +
                        "exclusions and disclaimers. <br> " +
                        "<br> " +
                        "2. Hawke's Bay Regional Council's Hazard maps have been compiled using the best " +
                        "information available to the council.The maps indicate the extent of the " +
                        "hazard from analysis of information only.They do not necessarily reflect the " +
                        "greatest extent of the hazard suffered in the past, or likely to be suffered in " +
                        "the future. <br> " +
                        "<br> " +
                        " 3. The hazard information provided does not imply any actual level of damage to " +
                        "any particular structure, utility service or other infrastructure. <br> " +
                        "<br> " +
                        "4. These maps should not be relied upon as the sole basis for making any " +
                        "decision in relation to potential risk. <br> " +
                        "<br> " +
                        "5. The hazard information provided is regional in scope and cannot be " +
                        "substituted for a site-specific investigation.A suitably qualified and " +
                        "experienced practitioner should be engaged if a site specific investigation is " +
                        "required. <br> " +
                        "<br> " +
                        "6. Hawke's Bay Regional Council makes no representations, warranties or " +
                        "undertakings about any of the information in these maps and / or electronic files " +
                        "including, without limitation, their accuracy, completeness, quality or fitness " +
                        "for any particular purpose. <br> " +
                        "<br> " +
                        "7. The Hawke's Bay Regional Council shall not be liable for any loss or damage " +
                        "arising out of, or in connection with, the use of the information contained in " +
                        "these maps and/or electronic files. <br>" +
                        "<br> " +
                        "8. Hawke's Bay Regional Council reserves the right to change the content and/or " +
                        "presentation of any of the information contained in these maps at its sole " +
                        "discretion, including these notes and disclaimer. <br> " +
                        " <br> " +
                        " 9. These disclaimers and exclusions shall be governed by, and construed in " +
                        "accordance with, the laws of New Zealand.If any provision of these disclaimers " +
                        "and exclusions is unlawful, void or for any reason unenforceable, that " +
                ...
                var btn = new Button({ label: "I Accept the terms" });
                splashPage.containerNode.appendChild(btn.domNode);
